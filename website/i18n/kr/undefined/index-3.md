...
Helm이 업데이트된 구성을 별도의 리비전으로 적용했기 때문에 **`REVISION` 열**이 2로 업데이트된 것을 볼 수 있습니다. 이를 통해 필요한 경우 이전 구성으로 롤백할 수 있습니다.
...
이제 Helm이 어떻게 작동하는지 이해했으니, [기본 모듈](../index/)로 진행하세요.
