...
![Instance type naming convention](../../../fundamentals/managed-node-groups/graviton/assets/instance-type-name.webp)
...
:::info AWS Graviton requires ARM compatible container images, ideally multi-architecture (ARM64 and AMD64) allowing cross-compatibility with both Graviton and x86 instance types. :::
...
![EKS Managed Node Group with Graviton Processor](../../../fundamentals/managed-node-groups/graviton/assets/eks-graviton.webp)

:::tip The [retail store sample web application](https://github.com/aws-containers/retail-store-sample-app/tree/main#application-architecture) architecture contains [pre-built container images for both x86-64 and ARM64 CPU architectures](https://gallery.ecr.aws/aws-containers/retail-store-sample-ui). :::
