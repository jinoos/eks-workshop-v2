...
![MySQL with EBS](../../../fundamentals/storage/ebs/assets/mysql-ebs.webp)
...
:::info Why are we not updating the existing StatefulSet? The fields we need to update are immutable and cannot be changed. :::
...
![EBS Volume AWS Console Screenshot](../../../fundamentals/storage/ebs/assets/ebsVolumeScrenshot.webp)
